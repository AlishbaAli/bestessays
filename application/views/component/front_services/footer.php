...
<div class="popup-layer" id="bio_ep" data-test="popup">
    <input  id="url-page" type="hidden" value="/doc_essay">
...
<i class="icon f-ic7"></i>
 ...
 </div><script src="<?php echo base_url() ?>front_assets/build/calculator.720f8c8bf3814c8895c7.js" async></script><script src="<?php echo base_url() ?>front_assets/build/product.268c06b6e152d8be6066.js" async></script>
<style>
.cookies {
  position: fixed;
  bottom: 0;
