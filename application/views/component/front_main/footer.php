            ...
            <div class="col-md-7 col-lg-8 col-sm-12 col-xs-5">
                <div class="row bottom_links">
                    <div class="col-md-4 col-sm-4">
                        <ul>
                            <li><a href="<?php echo base_url() ?>front_assets/">Home</a></li>
...
<noscript><iframe src="<?php echo base_url() ?>front_assets/www.googletagmanager.com/ns.html?id=GTM-MTC9MMT"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->    
  <script async src="<?php echo base_url() ?>front_assets/rum-static.pingdom.net/pa-59f072b5f3f14ae82c7b23c6.js"></script><script src="<?php echo base_url() ?>front_assets/build/adaptive.263784e454a851df9e21.js" async></script>
<style>
.cookies {
  position: fixed;
  bottom: 0;
