<div id="body_content"><div class="content">  <section class="container pt_container">
...
<a href="order/index.html" class="button benefit_button">Order Now</a></div>
</div>
<div class="col-md-6  col-sm-6">
<div class="info_container">
<h4>Why choose Essaysrus.ca</h4>
...
<div class="mainBanner"><a href="order/index.html" id="dynamicBanner" class="firstTime">               </a></div>
</section>
    ...
    <table class="prices" cellspacing="0" cellpadding=0 id="prices" border="0" width="100%" >
        <tr>
            ...
            <td class="td_name">10 days</td>
                ...
                <a rel="" class="tooltip with_ff" href="order/index321b.html?doctype=0&amp;urgency=11&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>22.99                </a>
            </td>
                        <td id="val-11-2" class="dark">
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/231.png' alt='' class='wrlevel_logo'/>The most popular choice<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=11&wrlevel=2&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/231.png" alt="The most popular choice" class="wrlevel_logo"/>$</span>25.99                </a>
            </td>
                        <td id="val-11-27" class="light">
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/231.png' alt='' class='wrlevel_logo'/>The most popular choice<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=11&wrlevel=27&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/231.png" alt="The most popular choice" class="wrlevel_logo"/>$</span>29.99                </a>
            </td>
                                            </tr>
                  <tr class="td_null">
            <td class="td_name">7 days</td>
                        <td id="val-1-1" class="light">
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/232.png' alt='' class='wrlevel_logo'/>The best value<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=1&wrlevel=1&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/232.png" alt="The best value" class="wrlevel_logo"/>$</span>23.99                </a>
            </td>
                        <td id="val-1-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order076c.html?doctype=0&amp;urgency=1&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>26.99                </a>
            </td>
                        <td id="val-1-27" class="light">
                <a rel="" class="tooltip with_ff" href="order1271.html?doctype=0&amp;urgency=1&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">5 days</td>
                ...
                <a rel="" class="tooltip with_ff" href="order60e5.html?doctype=0&amp;urgency=3&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>24.99                </a>
            </td>
                        <td id="val-3-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order86e2.html?doctype=0&amp;urgency=3&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>27.99                </a>
            </td>
                        <td id="val-3-27" class="light">
                <a rel="" class="tooltip with_ff" href="orderdd45.html?doctype=0&amp;urgency=3&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">4 days</td>
                ...
                <a rel="" class="tooltip with_ff" href="order/index6075.html?doctype=0&amp;urgency=4&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>25.99                </a>
            </td>
                        <td id="val-4-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order/index30b2.html?doctype=0&amp;urgency=4&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>28.99                </a>
            </td>
                        <td id="val-4-27" class="light">
                <a rel="" class="tooltip with_ff" href="orderad86.html?doctype=0&amp;urgency=4&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">3 days</td>
                ...
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/231.png' alt='' class='wrlevel_logo'/>The most popular choice<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=5&wrlevel=1&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/231.png" alt="The most popular choice" class="wrlevel_logo"/>$</span>27.99                </a>
            </td>
                        <td id="val-5-2" class="dark">
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/232.png' alt='' class='wrlevel_logo'/>The best value<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=5&wrlevel=2&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/232.png" alt="The best value" class="wrlevel_logo"/>$</span>30.99                </a>
            </td>
                        <td id="val-5-27" class="light">
                <a rel="" class="tooltip with_ff" href="orderef7e.html?doctype=0&amp;urgency=5&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">48 hours</td>
                ...
                <a rel="" class="tooltip with_ff" href="order3851.html?doctype=0&amp;urgency=6&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>30.99                </a>
            </td>
                        <td id="val-6-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order28cd.html?doctype=0&amp;urgency=6&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>33.99                </a>
            </td>
                        <td id="val-6-27" class="light">
                <a rel="" class="tooltip with_ff" href="order8623.html?doctype=0&amp;urgency=6&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">24 hours</td>
                ...
                <a rel="" class="tooltip with_ff" href="order98f1.html?doctype=0&amp;urgency=7&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>34.99                </a>
            </td>
                        <td id="val-7-2" class="dark">
                <a rel="<img src='<?php echo base_url() ?>front_assets/img3.bestessays.com/images/vaslogo/231.png' alt='' class='wrlevel_logo'/>The most popular choice<br/>" class="tooltip with_ff" href="/order.php?doctype=0&urgency=7&wrlevel=2&curr=USD">
                    <span class="ptable_curr"><img src="<?php echo base_url() ?>front_assets/img1.bestessays.com/images/vaslogo/231.png" alt="The most popular choice" class="wrlevel_logo"/>$</span>37.99                </a>
            </td>
                        <td id="val-7-27" class="light">
                <a rel="" class="tooltip with_ff" href="order/index4dfd.html?doctype=0&amp;urgency=7&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">12 hours</td>
                ...
                <a rel="" class="tooltip with_ff" href="order5dab.html?doctype=0&amp;urgency=8&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>39.99                </a>
            </td>
                        <td id="val-8-2" class="dark">
                <a rel="" class="tooltip with_ff" href="orderd1eb.html?doctype=0&amp;urgency=8&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>42.99                </a>
            </td>
                        <td id="val-8-27" class="light">
                <a rel="" class="tooltip with_ff" href="order5d9c.html?doctype=0&amp;urgency=8&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">6 hours</td>
                ...
                <a rel="" class="tooltip with_ff" href="order50d8.html?doctype=0&amp;urgency=9&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>45.99                </a>
            </td>
                        <td id="val-9-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order7608.html?doctype=0&amp;urgency=9&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>48.99                </a>
            </td>
                        <td id="val-9-27" class="light">
                <a rel="" class="tooltip with_ff" href="order32e5.html?doctype=0&amp;urgency=9&amp;wrlevel=27&amp;curr=USD">
            ...
            <td class="td_name">3 hours</td>
                ...
                <a rel="" class="tooltip with_ff" href="orderfb33.html?doctype=0&amp;urgency=10&amp;wrlevel=1&amp;curr=USD">
                    <span class="ptable_curr">$</span>52.99                </a>
            </td>
                        <td id="val-10-2" class="dark">
                <a rel="" class="tooltip with_ff" href="order5c80.html?doctype=0&amp;urgency=10&amp;wrlevel=2&amp;curr=USD">
                    <span class="ptable_curr">$</span>55.99                </a>
            </td>
                        <td id="val-10-27" class="light">
                <a rel="" class="tooltip with_ff" href="orderd582.html?doctype=0&amp;urgency=10&amp;wrlevel=27&amp;curr=USD">
        ...
        <div id="level_table">
            <table>
                ...
                <tr>
                    ...
                    <td class="lt_col_2">
                        <img src="<?php echo base_url() ?>front_assets/images/adaptive/tick_bbg.png" alt="yes" width="18" height="18">
                    </td>
                    <td class="lt_col_3">
                        <img src="<?php echo base_url() ?>front_assets/images/adaptive/tick_bbg.png" alt="yes" width="18" height="18">
                    </td>
...
<link rel="stylesheet" href="<?php echo base_url() ?>front_assets/res_v1560415138/css/select2/select2.min.css">
<script src="<?php echo base_url() ?>front_assets/res_v1560415138/js/select2/select2.js"></script>
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/write-my-essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
                        data: "ajaxPos=2&ajaxOrder=3&doctype=" +$('#set-doctype').val()+"&currency="+currency,
                    beforeSend: function(){
            $price_area.addClass('loading');
            $price_area.css({'text-align':'center'});
            $price_area.html('<span id="prices-loading"><img border="0" src="<?php echo base_url() ?>front_assets/res_v1560415138/img/icons/ajax-loader.gif" width="32" height="32" /></span>')
        },
        ...
        for( i=0; i<uids.length; i++ )
        {
            ...
            for( j=0; j<wlids.length; j++ )
            {
                ...
                if(filterPagesNumber(numpages, dt, uids[i], wlids[j]) && ( !multiGroupPrices || ( multiGroupPrices && multiGroupPrices.prices[group_id][uids[i]] && multiGroupPrices.prices[group_id][uids[i]][wlids[j]] ) ) )
                {
                    ...
                    var js_link_id = '';
                    var order_link = 'order/index.html';
...
<ul class="infographics">             <li class="infographics1"></li>             <li class="seporator"></li>             <li class="infographics2"></li>             <li class="seporator"></li>             <li class="infographics3"></li>             <li class="seporator"></li>             <li class="infographics4"></li>             <li class="seporator"></li>             <li class="infographics5"></li>         </ul>
    ...
    <ul class="infographics_mobyle visible-xs">
     ...
     <section class="students_reviews pt_container">
        ...
        <h4>What <strong>students say</strong> about Essaysrus.ca</h4>
        <div class="carousel-inner">
        <div class="item active">
        <div class="student_img hidden-sm"><img src="<?php echo base_url() ?>front_assets/images/img33.jpg" alt="" /></div>
        <blockquote>
        <h5>James W.</h5>
        <h6>- USA</h6>
        ...
        <a href="testimonials.html">Read more reviews</a>     </blockquote></div>
        <div class="item">
        <div class="student_img hidden-sm"><img src="<?php echo base_url() ?>front_assets/images/img32.jpg" alt="" /></div>
        <blockquote>
        <h5>Paul S.</h5>
        <h6>- UK</h6>
    ...
    <a class="button benefit_button" href="order/index.html">Get a Quote</a></div>
    </div>
    <div class="col-md-6  col-sm-6">
    <div class="info_container">
    <h4>Why choose Essaysrus.ca</h4>
  ...
  <section class="seo_text">
    ...
    <div class="row">
    <div class="col-md-6">
<p><strong>Essaysrus.ca - your source for original essay writing, custom papers, and research papers.</strong></p>
<p>Our essay writers are experienced and ready to help you! Stop asking who will write your essay and <strong>let our professional essay writing service complete your assignments.</strong></p>
<h2>Don't Like Essay Writing?</h2>
<p>We understand how stressful your essay assignments can be. All you have to do is say the magic words, "write my essays" and you will get the help you need. <strong>Our paper writing service is ready to help you now with a custom essay that meets your needs and instructions.</strong></p>
</div>
    <div class="col-md-6">

<h3>Confused With Essay Writing?</h3>
<p>Buy your essay now from the most experienced essay writing service online. <strong>Since 1997, we have provided premium essay writing services</strong> to students just like you. When you are lost or confused and asking who will write your essays, we have the answer! Customers who buy essays from Essaysrus.ca get the trusted assistance of our educated paper writers who hold MA and PhD degrees.</p>
<h2>See What Makes Essaysrus.ca the Essay Writing Service You Can Trust</h2>
<p>- <strong>Any paper writing deadline is possible</strong><span style="font-weight: bold;"> - </span> Choose the essay writing service that is available to accept your order 24/7 and has real customer support. We guarantee to meet any deadline and any academic level. Stop wondering who will write your essay and order now to see why our essay services are the best!</p>
<p>- <strong>Returning Customers</strong> - Students who buy essays from our custom paper writing service always receive valuable discounts and savings. Buy your essay now and see for yourself why so many customers return to use our custom essay writing services again and again.</p>
    </div>
    </div>
    </section>    </div></div>  