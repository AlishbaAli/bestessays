...
<h1><a href="/glossary.php">Glossary</a> - Introduction Chapter</h1>
	is a pert of dissertation which gives all necessary information so that the reader fully understands the problems, the background, the topic, general principles and methodology of your research. This chapter should highlight a statement of purpose that shows how you are going to reveal the topic of your research paper. In introduction chapter you should explain how and why you have chosen the topic and tell the reader what your hypothesis is. It also explains the reader how the dissertation is organized. Introduction chapter must be concise and short, giving brief explanation of the conducted research and findings. This paper writing should create interest in the mind of reader's to read the following pages of dissertation.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/introduction_chapter.reloadprice/",
                        type:'GET',
                        dataType: "text",
