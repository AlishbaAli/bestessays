...
<h1><a href="/glossary.php">Glossary</a> - Review essay</h1>
	is an essay that evaluates the essay writer's feelings on the most significant points raised by the author of a piece of literature. It is a critical discussion of the book while the opinions of the writer are supported by evidence. There are two important steps: developing an argument about what is reviewed in the essay and completing a well-organized review. A critical analysis provided by the writer of the essay should also be based on other writings and the opinions of experts. Review essays have a general pattern: introduction, summary of the book, critical discussion, and conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/review_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
