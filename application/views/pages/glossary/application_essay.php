...
<h1><a href="/glossary.php">Glossary</a> - Application essay</h1>
	aims at demonstrating applicant's writing skills and ability to structure thoughts and ideas coherently. This easy should give explanation of the applicants' goals, what bring him\her to the program and give reasons why the program is ideal for the applicant. Admission essays should persuade the committee that you differ from other applicants and give reasons why to choose you. Although there are hundreds of possible topics that applicants can be asked to write an essay on, they all should give information about the person and the style in which the admission essay is written should intrigue the audience (admission committee).</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/application_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
