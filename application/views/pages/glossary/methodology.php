...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/methodology.reloadprice/",
                        type:'GET',
                        dataType: "text",
