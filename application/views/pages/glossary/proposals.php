...
<h1><a href="/glossary.php">Glossary</a> - Proposals</h1>
	are the type of paper writing that helps you to be approved or hired to do a project. Proposals may also include such documents as results of the survey, recommendations, technical background etc. A real proposal makes the audience approve and give permission to do the project. Some proposals aim at selling the projects they offer to do, others sell the writer himself as the person who is to do the project. There are two types of proposals: internal & external, solicited & unsolicited. The memorandum format is used for internal proposals while the business-letter format is preferred for external proposals. All proposals usually contain introduction, the presentation itself, and conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/proposals.reloadprice/",
                        type:'GET',
                        dataType: "text",
