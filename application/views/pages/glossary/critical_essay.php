...
<h1><a href="/glossary.php">Glossary</a> - Critical essay</h1>
	is the essay that shows the essay writer's attitude of the work such as book, painting, article etc. Critical essay is not a simple summary of the content of other work; it is not even an essay which shows your opinion of the work's value. Such an essay presents an objective analysis of the work supporting it with subjective evidences. A critical essay examines positive and negative aspects and stresses the whole work. It is not your personal evaluation of the work because all claims you give should be supported by evidences from the text. Critical essay is never written in the first person and has a general essay writing format: title, introduction, body, and conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/critical_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
