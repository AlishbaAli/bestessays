...
<h1><a href="/glossary.php">Glossary</a> - Classification essay</h1>
	is the essay in which things are organized / sorted into categories and the writer of the essay gives examples of the things under each category. The most important thing about classification essay writing is choosing the appropriate classification criteria. The language of this essay is characterized by the usage of such transitions as the first kind / type / group. The introduction of the essay should be straightforward while the thesis statement it is necessary to point out the topic of the essay and how it is classified. Paragraphs in the body should define each type that was mentioned in the thesis statement. Each category should be supported by examples while the most important category should be elaborately explained.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/classification_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
