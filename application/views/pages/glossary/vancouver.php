...
<h1><a href="../glossary.html">Glossary</a> - Vancouver</h1>
	is a style which is used primarily for publications in biomedicine, medicine, medical technology and allied health sciences. The peculiarity of the style is the usage of a notational method of referencing. A citation in this style is given with a number in superscript format or enclosed by round brackets.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/vancouver.reloadprice/",
                        type:'GET',
                        dataType: "text",
