...
<h1><a href="/glossary.php">Glossary</a> - Page Headers</h1>
	as well as footers are used for the content that should be repeated on many pages of your essay, research paper etc. These are page numbers or chapter titles which are easily repeated when the content changes.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/page_headers.reloadprice/",
                        type:'GET',
                        dataType: "text",
