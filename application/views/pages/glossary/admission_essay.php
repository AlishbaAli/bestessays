...
<h1>Glossary - Admission essay</h1>
	is an essay written by a potential student. Admission essay is as a part of admission process which aims at conveying a sense of applicant's unique character to the admissions committee. This essay shows writing skills and ability to express ideas and thoughts coherently. The admission essay writing is very important because applicants demonstrate their unique fit to the university, company or program and its purpose is to differ from other applicants with this admission essay. It is usually an essay writing similar to autobiographical statement and requires the description of life experience and goals.</div>          <section class="place_for_baner">
...
<link rel="stylesheet" href="/res_v1561624627/css/select2/select2.min.css">
<script src="/res_v1561624627/js/select2/select2.js"></script>
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/admission_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
            ...
            $price_area.html('<span id="prices-loading"><img border="0" src="/res_v1561624627/img/icons/ajax-loader.gif" width="32" height="32" /></span>')
        },
    ...
    function doUpdateFeatures()
    {
        ...
        var currencyRates = {"AUD":1.43013,"CAD":1.31067,"EUR":0.88314,"GBP":0.78863,"USD":1};
