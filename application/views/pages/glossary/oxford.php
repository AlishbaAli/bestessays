...
<h1><a href="/glossary.php">Glossary</a> - Oxford</h1>
	style presents a set of conventions for paper writing which cover the following topics: spelling, typographic formats and punctuation. This style presuppose making citations in the body paragraphs, footnotes at the bottom of each page, a bibliography at the end of the paper with details for each source referred to.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/oxford.reloadprice/",
                        type:'GET',
                        dataType: "text",
