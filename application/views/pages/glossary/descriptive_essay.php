...
<h1><a href="../glossary.html">Glossary</a> - Descriptive Essay</h1>
	is an essay in which detailed descriptions and observations are used in order to lure the reader and make him read without stopping the whole essay. Writing a descriptive essay it is important to identify exactly what is to be described and why this certain object is chosen for an essay. Description in such an essay should be focused on the senses, and give vivid details that show readers what you are describing. The key to good description essay is a strong vocabulary and lack of passion in choosing the proper vocabulary. - See more at: https://www.bestessays.com/glossary/descriptive_essay.php#sthash.wmNlhHqX.dpuf</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/descriptive_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
