...
<h1><a href="/glossary.php">Glossary</a> - Argumentation</h1>
	includes debate and negotiation the purpose of which is to reach mutually acceptable conclusions. It consists of a claim, the logical reasoning and evidences that support the claim, the presentation of opposing views and refutation of the latter. Argumentation serves to protect beliefs in a dialogue and in the process of arguing. There are deductive and inductive arguments, each of them has different rules of logic that can be applied to produce valid arguments. - See more at: https://www.bestessays.com/glossary/argumentation.php#sthash.VDmCMbX4.dpuf</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/argumentation.reloadprice/",
                        type:'GET',
                        dataType: "text",
