...
<h1><a href="/glossary.php">Glossary</a> - Text alignment</h1>
	is the setting of text flow or image placement which refers to a page, column, table cell or tab. The text-align property is supported in all major browsers.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/text_alignment.reloadprice/",
                        type:'GET',
                        dataType: "text",
