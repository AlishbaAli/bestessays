...
<h1><a href="/glossary.php">Glossary</a> - CBEP</h1>
<p>is a citation style. It&rsquo;s most commonly used in computer sciences, physics, health sciences, biology and mathematics, but it isn&rsquo;t limited to only these. According to academic standards, each of the sources used in text must be properly cited, which is where the guidelines that accompany CBEP come into light.</p>
<p>The CBEP style differentiates between two different formats: the Name-Year and the Citation-sequence or C-S system. Based on the rules of these formats, it is the job of students and academics to properly organize, numerate, and alphabetize all the sources in the text.</p>
<p>The C-S system is most commonly used in mathematics, physics, computer science and health. The latter is most frequently used in biological and earth sciences.</p>
