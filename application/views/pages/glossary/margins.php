...
<h1><a href="../glossary.html">Glossary</a> - Margins</h1>
	are the distance or space between the edge of the page and the paper's main content. By default, page margins in Word are 1 inch at the top and bottom and 1.25 inches on the left and right (or 25.4 mm and 31.7 mm, respectively). The writer may change the margins on the Margins tab of the Page Setup dialog box in File menu.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/margins.reloadprice/",
                        type:'GET',
                        dataType: "text",
