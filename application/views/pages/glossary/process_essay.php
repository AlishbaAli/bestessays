...
<h1><a href="/glossary.php">Glossary</a> - Process essay</h1>
	is an essay in which the writer informs the reader how to do something or describes the way something has been done. The title of the essay tells the reader what process will be described. The introduction part if focused on the importance of this process and gives the aim of essay writing, defines the background information and the process itself. In the body of the essay each step should be supported by explanation and examples and written coherently. Concluding paragraph summarizes the main steps of the process and presents the paraphrase of the thesis sentence.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/process_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
