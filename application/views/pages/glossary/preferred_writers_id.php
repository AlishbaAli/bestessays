...
<h1><a href="/glossary.php">Glossary</a> - Preferred writer's ID</h1>
is the services offered by custom essay writing services for customers who need help with their essay writing. Choosing the essay writer makes the customer convinced that his order will be completed by a certain writer. This service is available for returning customers who have already had experience in ordering from the paper writing service. In case the essay writer accepts the order, the customer is charged additional payment which goes directly to the writer.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/preferred_writer's_id.reloadprice/",
                        type:'GET',
                        dataType: "text",
