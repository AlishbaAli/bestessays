...
<h1><a href="../glossary.html">Glossary</a> - Cause and Effect Essays</h1>
	examine why things happen and what happens as a result. In other words these essays are concerned with cause and effects. Cause and effect essay writing is a common method which is used for organizing and discussing ideas. Such paper writing requires of the student to pay attention on whether essay writing aims at informing or persuading the readers. Supporting evidence is what makes such an essay bright. Essay writing presupposes giving answers to the following questions: what are the causes? What are the effects? Which should be emphasized? Are there single or multiple causes/effects? Is there a chain reaction?</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/cause_and_effect_essays.reloadprice/",
                        type:'GET',
                        dataType: "text",
