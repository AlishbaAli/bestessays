...
<h1><a href="/glossary.php">Glossary</a> - Thesis Proposal</h1>
	is a detailed summary of the dissertation that informs the committee on whether the subject and the topic are appropriate to the field of study. The most important factors of each thesis proposal are the topic, the thesis statement, the main question, the introduction, Literature Review, Methodology and References. A good thesis proposal gives the outline of the topic, defines all the questions under consideration, describes the materials used while paper writing. A thesis proposal comprises a title page and brief summary of the proposal. The goal of thesis proposal writing is to convince the committee that topic should be approved and it helps the student to write the whole dissertation.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/thesis_proposal.reloadprice/",
                        type:'GET',
                        dataType: "text",
