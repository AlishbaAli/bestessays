...
<h1><a href="/glossary.php">Glossary</a> - CSE</h1>
<p>is an acronym for The Council of Science Editors. This council has created three very specific systems for paper format and organization. Each of the three systems contain a list of references at the end of the writing, in which the reader can get the information needed to track the writer’s sources.</p>
<p>This style guide also has its set of rules for in-text references that point out to the exact sources that support the content’s information. The three systems of CSE differ in the formatting of in-text references, as well as the organization of the title page, reference list, as well as the heading order.</p>
<p>The three systems are the citation-name system, citation-sequence system, and the name-year system.</p>
