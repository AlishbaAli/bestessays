...
<h1><a href="/glossary.php">Glossary</a> - VIP support</h1>
	is a service offered by many custom essay writing services. Professionalism and the speed of completing the order are the key characteristics of VIP support. It also presupposes immediate answer to all customers' questions and live communication with the representatives of custom paper writing services any time needed.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/vip_support.reloadprice/",
                        type:'GET',
                        dataType: "text",
