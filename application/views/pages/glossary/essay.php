...
<h1><a href="/glossary.php">Glossary</a> - Essay</h1>
	is a short piece of writing which is sometimes called a story. It is usually written from the author's personal point of view and describes, discusses and analyzes a certain topic. Most of modern essays are written in the form of prose, while essay writing in the form of verse is called dubbed essay. There are different purposes and occasions for writing essays. There exist various types of essay writing: definition essay, critical essay, personal essay, persuasive essay, research essay, comparison essay, exploratory essay, narrative essay etc.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
