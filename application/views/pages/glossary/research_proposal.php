...
<h1><a href="/glossary.php">Glossary</a> - Research Proposal</h1>
	is a type of paper writing that addresses a certain scientific or academic research and contain comprehensive literature reviews. The goal of research proposals is to convince the reader that the research will be perfectly conducted and that the writer has the competence and the work-plan to complete it. Research proposals should offer strong support so that the research study being proposed and describe a detailed methodology for conducting the research. All research proposals have the same format with the only exception that they should be written in future tense. This paper writing should contain all the key elements of the research process and give enough information for the readers to evaluate the proposed study.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/research_proposal.reloadprice/",
                        type:'GET',
                        dataType: "text",
