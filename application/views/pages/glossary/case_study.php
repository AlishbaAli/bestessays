...
<h1><a href="../glossary.html">Glossary</a> - Case Study</h1>
	is a research methodology which is useful in describing person's experiences, results and it is based on a profound investigation of a person, group, or event. Case studies provide a systematic way of looking at events, analyzing information, gathering data, and reporting the results. A case can be individuals, programs, or any unit, depending on what is to be examined through in-depth analysis and comparison.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/case_study.reloadprice/",
                        type:'GET',
                        dataType: "text",
