...
<h1><a href="../glossary.html">Glossary</a> - Footnotes</h1>
	The writer can place footnotes beneath the page's text or at the bottom of the page still Word gives the writer the option to number the notes through the document and to restart numbering for each new page.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/footnotes.reloadprice/",
                        type:'GET',
                        dataType: "text",
