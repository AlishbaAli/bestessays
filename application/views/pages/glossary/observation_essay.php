...
<h1><a href="../glossary.html">Glossary</a> - Observation essay</h1>
	is a kind of essay that gives the reader a clear image of an event or circumstance and is usually focused on a certain thing that is described in details by essay writer. If the writer knows that he would have to write the observation essay, he'd better make notes right after the event took place because fresh impressions are the brightest. Although the observation essay is based on the writer's previous experiences, essay writing should have objective tone rather than a subjective one.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/observation_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
