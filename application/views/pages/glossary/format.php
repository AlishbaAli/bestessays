...
<h1><a href="/glossary.php">Glossary</a> - Format</h1>
	or a style is usually applied to the whole document but may be also applied to different sections of the research paper, dissertation if needed with a single click. Word offers various styles and formatting which may be chosen with the help of the Styles and formatting button on the Formatting toolbar.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/format.reloadprice/",
                        type:'GET',
                        dataType: "text",
