...
<h1><a href="/glossary.php">Glossary</a> - Informational Interviews</h1>
	are meetings in which job seekers get necessary information on certain filed to expand their professional skills. In this interview the job seeker asks questions regarding salary, benefits, vacation etc. Informational interview gives a job seeker the opportunity to build self-confidence and to improve his ability to conduct a job interview. Although the conversation is usually friendly, and rather brief, focused on the contact person's job and career field, both the interviewer and the job seeker should conduct themselves in a professional manner.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/informational_interviews.reloadprice/",
                        type:'GET',
                        dataType: "text",
