...
<h1><a href="/glossary.php">Glossary</a> - Multiple Choice Questions</h1>
	is a type of assessment students' knowledge in which they should select the best possible answer to the question out of the given choices. Multiple choice questions consist of a stem and a set of options. Both writing and fulfilling a good multiple-choice question requires serious thought, critical thinking, good abilities of analysis and a range of skills and knowledge.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/multiple_choice_questions.reloadprice/",
                        type:'GET',
                        dataType: "text",
