...
<h1><a href="/glossary.php">Glossary</a> - Harvard</h1>
	style is a citation style in which citations within the text of essays, research papers or other types of paper writing must be enclosed within parentheses and included in the paragraph. This style is opposed to the footnote style and may be a full or partial citation. In-text citations and end sections may be presented in two ways within Harvard style: "author-date" and "author-page".</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/harvard.reloadprice/",
                        type:'GET',
                        dataType: "text",
