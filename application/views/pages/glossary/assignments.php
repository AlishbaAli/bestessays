...
<h1><a href="../glossary.html">Glossary</a> - Assignments</h1>
	are the various works performed by students which are used by teachers and professors at schools, colleges, universities to access students' knowledge and to cooperate with them. In order to do assignments it is sometimes necessary to do some research. There are various assignments, such as essay writing, term paper writing, making presentations etc.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/assignments.reloadprice/",
                        type:'GET',
                        dataType: "text",
