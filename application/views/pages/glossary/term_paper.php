...
<h1><a href="/glossary.php">Glossary</a> - Term paper</h1>
	is a kind of research paper which describes events, concepts or argues a certain point. Term paper is written by students usually at the end of each semester and intends to discuss a topic under consideration in details. The length of term paper is usually several typed pages and shows that the writer has a strong understanding of the topic and source material used. It is necessary to draw a border between such terms as "term paper" and "research paper" because not all term papers presuppose academic research.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/term_paper.reloadprice/",
                        type:'GET',
                        dataType: "text",
