...
<h1><a href="/glossary.php">Glossary</a> - Personal Essay</h1>
	is a kind of essay that shows and tells the reader who you are and is often required of applicants by admissions committee. An essay that reveals the right balance of personal and academic characteristics and specifics would be a perfect essay for an applicant to be admitted. The personal essay is often a good device of self-expression so at the beginning there should be an original and provoking opening paragraph. Personal essays present essay writer's unique view of the topic and include three ordinary paragraphs: introduction, body paragraphs, and conclusion. The personal essay is an expression of feelings and opinions so unique ideas are valued.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/personal_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
