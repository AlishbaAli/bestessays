...
<h1><a href="/glossary.php">Glossary</a> - Paragraphs</h1>
is a formatting that can be applied to as little as one paragraph, such as paragraph spacing before and after, line spacing, indents etc.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/paragraphs.reloadprice/",
                        type:'GET',
                        dataType: "text",
