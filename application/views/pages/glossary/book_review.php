...
<h1><a href="/glossary.php">Glossary</a> - Book Review</h1>
	is a form of literary criticism while the book is analyzed according to style, content, and merit. Its length may vary from a single paragraph to an essay. Book review is much more personal than a book report. It is an expression of the reader's opinion of the book. It includes not only factual content as the report but also gives reader's personal opinions which are the key thing about book reviews.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/book_review.reloadprice/",
                        type:'GET',
                        dataType: "text",
