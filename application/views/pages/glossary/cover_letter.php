...
<h1><a href="/glossary.php">Glossary</a> - Cover Letter</h1>
	is a specific type of paper writing which is written specifically to the position a person is applying for. It is a letter of motivation which is attached to a resume or curriculum vitae while applying for a job. It should highlight the most relevant experience from the resume and present the connection of that experience with the position a person is applying for. Cover letter reflects person's attitude, personality, motivation, and enthusiasm. As for the structure, cover letter is one page in length, consists of a header, introduction, body, and closing.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/cover_letter.reloadprice/",
                        type:'GET',
                        dataType: "text",
