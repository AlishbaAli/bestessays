...
<h1><a href="/glossary.php">Glossary</a> - Book Report</h1>
	is a description that gives a brief summary of a book and a reaction to it. It includes information on the author, title, place and year of publication as well as a summary of the content of the book. A book report is usually written for the readers of the book and is completely factual. Although book reports have a certain format they may vary in length and complexity depending on the academic level and the importance of the individual assignment.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/book_report.reloadprice/",
                        type:'GET',
                        dataType: "text",
