...
<h1><a href="../glossary.html">Glossary</a> - Editing</h1>
	is a process of reviewing and making changes to a document, essay, term paper, research paper or other types of paper writing. Editing presupposes making deletions, additions, changing the format and the style and other changes to conform to the highest standards. Editing is equated with correcting, revising, or adapting. It is often applied to different documents for public presentation and publication. Editing can also be part of writing process not only for non-fiction books and documents but also fiction. Editing can be performed on several levels: content, overall structure, structure within paragraphs, clarity, style, citations.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/editing.reloadprice/",
                        type:'GET',
                        dataType: "text",
