...
<h1><a href="../glossary.html">Glossary</a> - Presentation</h1>
is the practice of explaining the content of a certain topic for the audience with the help of presentation program. The purpose of presentation is to give the applicants a chance to demonstrate abilities and skills in making such presentations, as well as to show profound knowledge in the field the applicant is going to work in. Presentation is limited in time and the applicant should manage to make the presentation within this time. As the applicant is usually given only the title for presentation, he may show the creativity which is highly valued.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/presentation.reloadprice/",
                        type:'GET',
                        dataType: "text",
