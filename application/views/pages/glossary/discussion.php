...
<h1><a href="/glossary.php">Glossary</a> - Discussion</h1>
	is a type of paper writing which aims at stating your opinions, explaining the implications of findings, and making suggestions for future research. The organization is the most important thing about discussion that's why the logical organization of thoughts is vital. While writing a discussion with the aim of presenting arguments from different points of view, it is necessary to think about the issue, give for and against evidences and explain your point of view. On the other hand, a persuasive writing presupposes starting discussion with an opening statement and making a conclusion at the end. The discussion should include facts and examples.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/discussion.reloadprice/",
                        type:'GET',
                        dataType: "text",
