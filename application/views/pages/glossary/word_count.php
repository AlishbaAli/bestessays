...
<h1><a href="/glossary.php">Glossary</a> - Word count</h1>
	is a free tool that counts the number of words submitted to it such as words made out of the alphabet or from a combination of alphabets and numbers. Although the toll does not count words starting with an apostrophe or a hyphen, words made solely from numbers, and HTML tags.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/word_count.reloadprice/",
                        type:'GET',
                        dataType: "text",
