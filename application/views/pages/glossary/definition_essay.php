...
<h1><a href="/glossary.php">Glossary</a> - Definition Essay</h1>
	is essay writing that presupposes explaining the definitions of different terms whether they are abstract or have concrete meaning. The peculiarity of this essay is that the essay writer should give the definition in his own words. The reader of the essay should get the following information: what term is being defined, a clear definition of this term supported by illustrative material, such as examples or facts. The following methods of explaining the term may be chosen: details, analysis, comparison, examples and anecdotes, origin and causes, effects and results or negation. Definition essay should have good transitions to link different parts of the essay and a strong conclusion that brings the parts of definition together.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/definition_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
