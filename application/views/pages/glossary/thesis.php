...
<h1><a href="/glossary.php">Glossary</a> - Thesis</h1>
	is a form of paper writing which presents the writer's research and finding in certain field of science. Thesis is submitted for getting a Ph or MA degree and has a title, an abstract, a table of contents, a body with several chapters, and a bibliography. The purpose of the thesis is to state clearly an original contribution to knowledge in certain sphere or the application of known techniques in a new area. Thesis is a scientific research report which is written to prove the writer's competence in the field; helps to qualify the author of this paper writing for the degree or other professional qualification.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/thesis.reloadprice/",
                        type:'GET',
                        dataType: "text",
