...
<h1><a href="/glossary.php">Glossary</a> - Personal Statement</h1>
	is usually a multiple essay in which responses to three or more questions are given. This essay gives additional evidence of intellectual and creative achievement of the applicant so it is possible to attach academic record in the list of opportunities. The most important part of personal statement is to mention why you want to be admitted. All paragraphs should start and finish with interesting phrases making the tone of your essay polite. Language which makes you sound enthusiastic about your goals and an interesting person is the key for writing a fresh personal statement.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/personal_statement.reloadprice/",
                        type:'GET',
                        dataType: "text",
