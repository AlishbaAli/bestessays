...
<h1><a href="/glossary.php">Glossary</a> - Research Essay</h1>
	is a type of essay that makes the writer analyze the works of others and compare their ideas and thoughts with his own. Research essay is a clearly-written and well-organized essay that involves researching source material and synthesizing what you learn from it with your own ideas. Thesis is the most important part of essay and each research essay should have original thesis which shows essay writer's thorough research and good writing. Research essay has a structure typical for all essays: introduction, body and conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/research_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
