...
<h1><a href="../glossary.html">Glossary</a> - Coursework</h1>
	is the work carried out by students at universities and may be presented in the form of experimental work which presupposes deep research in a certain sphere of science. Coursework usually involves writing various papers, speeches laboratory projects etc. While completing the assignment students are allowed to use any material and sources they need, such text books, notes, and the Internet for research. The purpose of writing coursework is to develop research skills, to expand students' knowledge, improve their abilities to take practical results on the basis of the theoretical knowledge. Students are usually evaluated for their organization, research, and presentation skills.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/coursework.reloadprice/",
                        type:'GET',
                        dataType: "text",
