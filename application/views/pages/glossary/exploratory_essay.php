...
<h1><a href="/glossary.php">Glossary</a> - Exploratory essay</h1>
	is a kind of essay writing aiming at learning rather than to proving that an essay writer knows something about the topic. Writing an exploratory essay, it is necessary to think about the advantages and disadvantages of the topic\subject of the essay. Exploratory essay begins with a question that will be answered in the course of essay writing, and then another question is posed that is also to be answered in the essay. These essays do not have a thesis while they focus on a question. The purpose of writing exploratory essay is to widen essay writers' vision to the whole topic of the essay.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/exploratory_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
