...
<h1><a href="/glossary.php">Glossary</a> - College Application Essay</h1>
	is an essay required of students who want to get into college. Application essays should have a clear focus on essay's building materials such as writing about experience, people who have influenced the applicant's identity, places where the applicant spent much time etc. Application essay is the essay which helps applicants to gain admittance to the college and that's why essay writing should show that the applicant is thoughtful and mature, that his personality has depth, and he\she has all necessary skills.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/college_application_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
