...
<h1>Glossary - Abstract</h1>
	is the summary of paper writing which gives information about the authors, brief descriptions of the methods which were used in the paper. Abstract may also be a very important part of dissertation which gives summary of the contents of the dissertation. It should include the tested hypotheses and obtained results and conclusions of the work. It gives a short explanation of what the paper contains but it is not a review, so it does not give any evaluations of the paper that is abstracted. The abstract is an original paper and not an excerpted passage.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/abstract.reloadprice/",
                        type:'GET',
                        dataType: "text",
