...
<h1><a href="../glossary.html">Glossary</a> - Article Critique</h1>
	is the paper writing which gives evaluation of the article and how it is presented to the person who reads it. Usually it is the paper with analyzes, interprets, and evaluates the text, and answers the questions how? why? and how well? It is not a summary of the article; it is a critical analyses which should not always be in a negative sense. Article critique is written in standard essay form. In introduction there is the subject of the article critique and your point of view. Specific issues and aspects of the argument help to defend this point of view. In conclusion summary of the argument and re-emphasize of opinion should be given.</div>          <section class="place_for_baner">
...
<link rel="stylesheet" href="../res_v1560415141/css/select2/select2.min.css">
<script src="../res_v1560415141/js/select2/select2.js"></script>
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/article_critique.reloadprice/",
                        type:'GET',
                        dataType: "text",
            ...
            $price_area.html('<span id="prices-loading"><img border="0" src="/res_v1560415141/img/icons/ajax-loader.gif" width="32" height="32" /></span>')
        },
