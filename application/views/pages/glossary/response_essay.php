...
<h1><a href="../glossary.html">Glossary</a> - Response essay</h1>
	is an essay that provides the reader with a better understanding of the essay writer's personal feelings, his personal points of view and ideas concerning a certain subject. The majority of response essays are written in response to the watched movie or read book\article where the writer expresses his viewpoint. It is usually an introductory paragraph with a thesis statement that states this point of view and is further content supports this thesis. The response essay is written in the first person and has the same structures as typical essays: introduction, body paragraphs and conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/response_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
