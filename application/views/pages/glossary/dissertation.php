...
<h1><a href="/glossary.php">Glossary</a> - Dissertation</h1>
	is paper writing submitted in support of candidature for Ph or MA degree and presents the author's research and findings in particular field of science. Dissertation helps to enhance such intellectual skills as assessment, synthesis and analysis. Dissertation is an extended piece of writing which contains a detailed exploration of evidence. Precise details about the format, layout and stylistic requirements of your assignments should be given by the professor. Usually the following structure is required of clear introduction, followed by the main body of your argument, and then a conclusion.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/dissertation.reloadprice/",
                        type:'GET',
                        dataType: "text",
