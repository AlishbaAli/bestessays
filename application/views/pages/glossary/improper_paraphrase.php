...
<h1><a href="../glossary.html">Glossary</a> - Improper paraphrase</h1>
	is also considered to be plagiarism so it is obligatory to use your own words when you are paraphrasing the thought you have read. In case the writer includes a unique phrase or word within the paraphrased section in his essay, research paper etc, he should enclose the word or phrase with quotation marks. Paraphrasing may be done also with the help of acknowledging the author in parentheses after the paraphrased sentence or by using a footnote.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/improper_paraphrase.reloadprice/",
                        type:'GET',
                        dataType: "text",
