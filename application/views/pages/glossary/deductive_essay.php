...
<h1><a href="/glossary.php">Glossary</a> - Deductive Essay</h1>
	is the essay that shows the most reasonable and logical conclusion which is based on the initial information. Deductive essay and deductive thinking are interwoven while the latter represents reasons taken from the general to the particular. Each paragraph in the body of a deductive essay should be focused on a certain fact which is to be analyzed in details and this should be followed by a logical conclusion. The support of each conclusion is the key factor in writing a deductive essay. The final conclusion of the essay is based on the essay writer's life experience and emotions.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/deductive_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
