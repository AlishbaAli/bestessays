...
<h1><a href="/glossary.php">Glossary</a> - Interview essay</h1>
	is a type of essay writing type which is created after the author of the essay conducted an interview. All questions in an interview essay must be very precise to avoid incorrect personality portrait. As for interview essay writing, the introduction paragraph should begin with an anecdote about the person that was interviewed. Make sure the answers are direct quotes from the interviewee but the interview essay can also be written in a narrative essay form. Interview essay has a simple structure: introduction, body and conclusion. A good interview essay should not be a simple summary of the answered questions but give a clear whole-personality portrait.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/interview_essay.reloadprice/",
                        type:'GET',
                        dataType: "text",
