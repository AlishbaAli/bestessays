...
<h1><a href="../glossary.html">Glossary</a> - Lab Report</h1>
	is an important part of all laboratory courses and you it explains what you did in experiment, what you learned, and what the results meant. Lab report should demonstrate that the writer understands the concepts behind the data. It identifies the reasons and the ways differences have occurred and explains their influence upon the experiment. Finally, lab report shows that a person who conducted the experiment has a full comprehension of the principles the experiment was designed to examine. A key element in such paper writing is careful organization of ideas and their coherent expression.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/lab_report.reloadprice/",
                        type:'GET',
                        dataType: "text",
