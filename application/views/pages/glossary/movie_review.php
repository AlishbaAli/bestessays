...
<h1><a href="/glossary.php">Glossary</a> - Movie Review</h1>
	is the analysis of the film made by one person or collectively expressing the opinion on the movie. The peculiarity of movie review is that it does not simply evaluate the movie but gives very specific opinions which are the foundation of film review. This paper writing as well as writing essays, research papers, and term papers should entertain the reader and grab the reader's attention immediately. At the beginning it is vital to mention the reputation of actors and director and write what your expectations were and whether they were fulfilled. The reviewer should explain how the story builds without recollecting key moments and ending. The review should be concise and engaging with the use of metaphors, specific adjectives, analogies, similes etc.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/movie_review.reloadprice/",
                        type:'GET',
                        dataType: "text",
