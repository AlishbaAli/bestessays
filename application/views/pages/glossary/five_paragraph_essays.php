...
<h1><a href="/glossary.php">Glossary</a> - Five paragraph essays</h1>
	is the essay that has five paragraphs: one introductory paragraph, three body paragraphs with support and development, and one concluding paragraph. The introductory paragraph should include the thesis statement and motivate the reader to read the essay up to the end. The first and the second paragraphs of the body should contain the strongest arguments supported by the brightest examples while the third paragraph should have the weakest argument and illustrations. The conclusion should be a restatement of the thesis statement, and a summary of three body paragraphs.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/five_paragraph_essays.reloadprice/",
                        type:'GET',
                        dataType: "text",
