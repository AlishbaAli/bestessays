...
<h1><a href="../glossary.html">Glossary</a> - Reaction Paper</h1>
	is a form of paper writing in which the writer expresses his ideas and opinions about what has been read or seen. Reaction paper is evaluated due to the writer's communication skills and only then due the unique ideas and the content. This paper writing may be informal, two pages long. As all essays, a reaction paper comprises introduction, body, and conclusion. In introduction the writers states the main premise, in a body he expresses his ideas and in conclusion summarizes the results. The reaction paper is not a summary of the article although information should be included.</div>          <section class="place_for_baner">
...
<script type="text/javascript">
    ...
    var PriceTable = {
        ...
        onChangeDoctype : function()
        {
            ...
            $.ajax({
                        url: "/glossary/reaction_paper.reloadprice/",
                        type:'GET',
                        dataType: "text",
