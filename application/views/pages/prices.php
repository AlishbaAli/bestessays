...
<h1>PRICES - ACADEMIC PAPER WRITING</h1>
        ...
        <div id="level_table">
            <table>
                ...
                <tr>
                    <th class="lt_col_1">
                        High priority order
                        <a title="With the high priority status, your order will be the first in line to get assigned to an expert" class="field_hint" href="javascript:void(0);"><img alt="?" src="<?php echo base_url() ?>front_assets/images/adaptive/tooltip.png"></a>
                    </th>
                    <td class="lt_col_2">
                        —
                    </td>
...
<ul class="infographics">             <li class="infographics1"></li>             <li class="seporator"></li>             <li class="infographics2"></li>             <li class="seporator"></li>             <li class="infographics3"></li>             <li class="seporator"></li>             <li class="infographics4"></li>             <li class="seporator"></li>             <li class="infographics5"></li>         </ul>
  ...
  <div class="rs_main_part container"><a class="button_order_now" href="order/index.html">Order now</a></div>  <section class="seo_text">
<div class="container">
<div class="row">
<div class="col-md-6">
<p>If you've been trying to write an essay or a research paper, you may have already gathered the fact that it is a time-consuming, boring, and sometimes, an extremely annoying task. The problem is that some students don't go to a professional essay writing service to order their papers because they come with a tight budget.  We make it easy for every student at Essaysrus.ca.</p>
</div>
<div class="col-md-6">
<p>We understand that students will always have to fulfill several responsibilities during their academic career. Sometimes, it all becomes so complex that it shows on your grades. That's when you can come to us for help and expect high quality work at the most affordable rates.</p>
<p>We have trained writers on-board who understand how to write high quality papers while maintaining the highest linguistic standards. We guarantee you high quality papers and let you enjoy several other benefits as well.</p>
</div>
</div>
</div>
